...
@property (nonatomic, strong, readonly) BBAPainterGifImage* weakProxy;
...
+ (void)initialize {
    if (self == [BBAPainterGifImage class]) {//检查类型，防止多次继承之后调用
...
- (id)initWithGIFData:(NSData *)data {
    ...
    if (self) {
        ...
        _weakProxy = (id)[BBAPainterProxy proxyWithObject:self];
        @synchronized(allGIFImagesWeak) {
